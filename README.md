...
- **调研报告溯源（网络来源原文标红）**：导入带 `[(来源)](URL)` 引证的调研报告，左侧阅读报告，点击引证右侧弹出该网络来源的原文并标红支撑主张的原句；来源按 A–D 可信度分级，抓取失败与无法对句的引证诚实标记，不作掩饰
...
「调研溯源」模块：欢迎页点击「研于网海 · 溯源调研报告」进入（内置智能眼镜调研演示包）。为自己的调研报告生成溯源包：
